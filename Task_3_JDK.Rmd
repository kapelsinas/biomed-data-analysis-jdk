...
p_load(Signac, dplyr, heatmaply, reshape2, ggplot2, data.table, matrixStats,
       ...
       Heatplus, gplots, heatmap3, patchwork)
...
Parodoma kuris iš trijų naudojamų laikrodžių yra tiksliausias ir kuris yra mažiausiai tikslus. Naudododami DNAmAge funkciją pamatome, kad tiksliausias yra Horvarth laikrodis, kurio nuklydimo vidurkis ***`r MostAcc`***, o mažiausias tikslus yra Levine, kurio vidurkis ***`r LeastAcc`***

Taip pat parodo koreliacija tarp visų trijų laikrodžių.
...
# Tiksliausias laikrodis
MostAcc <- colnames(Acc)[max.col(-Acc, ties.method = "first")]
MostAcc
# Mažiausiai tikslus laikrodisi
...
Parodoma kaip nuspėti amžiai skiriasi tarp vartojančių apsiriną ir nevartojančių.
...
p1.Horvath.distal <- plotDNAmAge(age.t1.distal$Horvath, info.t2.distal$age,
                                 tit = "Horvath method (distal)")
p1.Hannum.distal <- plotDNAmAge(age.t1.distal$Hannum, info.t1.distal$age,
                                tit = "Hannum method (distal)")
p1.Levine.distal <- plotDNAmAge(age.t1.distal$Levine, info.t2.distal$age,
                                tit = "Levine method (distal)")

# Timepoint - t2:
p2.Horvath.proximal <- plotDNAmAge(age.t2.proximal$Horvath, info.t2.proximal$age,
                                   tit = "Horvath method (proximal)")
p2.Hannum.proximal <- plotDNAmAge(age.t2.proximal$Hannum, info.t1$age,
                                  tit = "Hannum method (proximal)")
p2.Levine.proximal <- plotDNAmAge(age.t2.proximal$Levine, info.t1$age,
                                  tit = "Levine method (proximal)")

p2.Horvath.distal <- plotDNAmAge(age.t2.distal$Horvath, info.t2.distal$age,
                                 tit = "Horvath method (distal)")
p2.Hannum.distal <- plotDNAmAge(age.t2.distal$Hannum, info.t2$age,
                                tit = "Hannum method (distal)")
p2.Levine.distal <- plotDNAmAge(age.t2.distal$Levine, info.t2$age,
                                tit = "Levine method (distal)")

p1.Horvath.proximal + p1.Horvath.distal + p1.Hannum.proximal + p1.Hannum.distal +
  p1.Levine.proximal + p1.Levine.distal +
    plot_layout(ncol = 2)
p2.Horvath.proximal + p2.Horvath.distal +
  p2.Hannum.proximal + p2.Hannum.distal +
