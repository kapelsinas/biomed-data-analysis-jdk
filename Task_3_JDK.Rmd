...
vec.t1 <- info.t1$basename
age.t1 <- age.all[age.all$id %in% vec.t1, ]

vec.t2 <- info.t2$basename
age.t2 <- age.all[age.all$id %in% vec.t2, ]

p1.Horvath <- plotDNAmAge(age.t1$Horvath, info.t1$age, tit = "Horvath method ( Time point 1 ) ", aes = c(color="red"))
p2.Horvath <- plotDNAmAge(age.t2$Horvath, info.t2$age, tit = "Horvath method ( Time point 2 ) " )

p1.Hannum <- plotDNAmAge(age.t1$Hannum, info.t1$age, tit = "Hannum method ( Time point 1 ) " )
p2.Hannum <- plotDNAmAge(age.t2$Hannum, info.t2$age, tit = "Hannum method ( Time point 2 ) " )

p1.Levine <- plotDNAmAge(age.t1$Levine, info.t1$age, tit = "Levine method ( Time point 1 ) " )
p2.Levine <- plotDNAmAge(age.t2$Levine, info.t2$age, tit = "Levine method ( Time point 2 ) " )
