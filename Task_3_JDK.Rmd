...
## 2. Klasterizavimo pritaikymas pozicijoms

```{r Extra_2, echo=FALSE, message=FALSE, warning=FALSE}
#selected_data <- annot_row[!is.na(annot_row$CpG_rs), ]
#df_island <- selected_data[selected_data$Relation_to_Island == "Island",]
#df_chr <- df_island[df_island$chr == "chr9",]
#df_mt <- as.data.frame(t(beta[rownames(df_chr), ]))

#dist_mat <- as.dist(1-cor(df_mt))
